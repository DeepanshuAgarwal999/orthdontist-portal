...
const BlogForm: React.FC<BlogFormProps> = ({ blog, mode }) => {
    ...
    const queryClient = useQueryClient(); const [formData, setFormData] = useState({
        title: blog?.title || '',
    ...
    const uploadFeaturedImage = async () => {
        ...
        try {
            ...
            // Update the featured image URL with the uploaded image
            setFormData(prev => ({
                ...prev,
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        {/* Current featured image or preview */}
